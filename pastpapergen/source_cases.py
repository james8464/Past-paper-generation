...
_DATA_RESPONSE_CASES: dict[str, list[str]] = {
    "demand": [
        "In 2024, UK supermarkets reported that shoppers bought more own-brand food and fewer premium branded products as food prices remained above their pre-pandemic level. Kantar data showed discounters increased market share, while some established chains used loyalty-card discounts to retain consumers. Economists said the demand response depended on real incomes, the availability of substitutes and whether consumers considered the products necessities or luxuries.",
        "Transport operators said demand for peak-time rail travel remained below 2019 levels because many office workers adopted hybrid working. Leisure journeys recovered more strongly when discounted fares were available. Operators argued that lower demand reduced total revenue on some routes, while consumer groups said high prices and unreliable services made demand more price elastic over time.",
        "A UK electronics retailer reported stronger demand for low-priced smartphones and refurbished laptops during 2023 and 2024. Higher interest rates and weak real wage growth reduced demand for expensive models. However, demand for some devices remained relatively price inelastic because consumers needed them for work, education and online services.",
        "Policy makers considered whether temporary support for low-income households would increase demand for essential goods. Supporters argued that households with a high marginal propensity to consume would spend most of any extra income. Critics argued that if supply was constrained, higher demand might mainly increase prices rather than real output.",
    ],
    "market structures": [
    ...
    "revenues, costs and profits": [
        "Ryanair and easyJet both reported in 2024 that fuel, airport charges and wage costs remained important pressures after international travel recovered. Airlines tried to keep load factors high because aircraft leases, landing slots and head-office costs are largely fixed in the short run. Selling extra seats can add relatively little to total variable cost, but lower fares may reduce average revenue if demand is price elastic.",
        "A UK bakery chain reported higher electricity, flour and staff costs during 2023 and 2024. Managers said price rises helped protect profit margins, but sales of premium products became more sensitive as household budgets were squeezed by inflation. The firm considered whether loyalty discounts would raise total revenue or simply reduce revenue from customers who would have bought at the original price.",
        "Consumers became more price sensitive during 2023 and 2024 as real incomes were squeezed. Tesco and Sainsbury's used loyalty-card discounts to protect sales volumes, while some suppliers said supermarket promotions reduced their margins. The effect on profit depended on whether higher quantities sold were enough to offset lower prices and higher costs for transport, packaging and wages.",
        "A manufacturer of electric vans said output could not expand quickly because specialist machinery and skilled labour were fixed in the short run. In the long run, investment in a larger factory could reduce average costs through technical economies of scale, but only if demand remained strong. Managers said battery packs, robotics and testing equipment required large upfront spending before any extra vans were sold. If demand weakened, the firm could face excess capacity, higher average fixed costs and pressure on profits.",
    ],
    "price determination": [
    ...
    "supply": [
        "The UK car industry was affected by shortages of semiconductors and batteries after the pandemic. The Society of Motor Manufacturers and Traders reported that firms had to adjust production schedules when components arrived late. Some manufacturers prioritised higher-margin models, while smaller suppliers said they could not expand output quickly because skilled labour and specialist machinery were fixed in the short run.",
        "Housebuilding firms said that planning delays, labour shortages and higher interest rates reduced the number of new homes brought to market during 2023 and 2024. Developers argued that supply was price inelastic because land, permissions and materials could not be increased quickly. Campaigners said slow supply growth contributed to higher rents and reduced affordability for younger households.",
        "National Grid has warned that connecting new renewable energy projects can take several years in areas where network capacity is limited. Energy companies said investment in wind and solar generation increased, but output could not always reach consumers without new transmission infrastructure. This created a time lag between higher expected prices and an increase in effective supply.",
        "Some food producers faced higher costs for fertiliser, energy and transport after global supply chains were disrupted. Larger supermarkets used long-term contracts to reduce price volatility, while smaller suppliers said cash-flow pressures made it difficult to hold stocks. The final effect on market supply depended on weather conditions, storage capacity and the price elasticity of supply.",
    ],
    "market failure": [
